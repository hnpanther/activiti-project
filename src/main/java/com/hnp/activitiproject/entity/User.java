package com.hnp.activitiproject.entity;
...
//        authorities.add(new SimpleGrantedAuthority("ACTIVITI_ADMIN"));
//
//        authorities.add(new SimpleGrantedAuthority("ROLE_ACTIVITI_USER"));
//        authorities.add(new SimpleGrantedAuthority("ACTIVITI_USER"));
